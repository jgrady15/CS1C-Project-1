...
#include <memory>
#include "../loginscreen/orderwindow.h"
...
QT_MOC_LITERAL(1, 12, 10), // "setProduct"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5) // "order"

    },
    "orderWindow\0setProduct\0\0order"
};
...
void orderWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setProduct((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->order(); break;
        default: ;
        }
    }
}
